...
class ShipTypes {
  ...
  */
  ...
  static {
    ...
    this.shipTypes.set(401, new Ship(401, 0, new Map([[210, 5]]), 20, [2000, 0], 80))
    this.shipTypes.set(402, new Ship(402, 0, new Map([[210, 5]]), 25, [1500, 500], 100))
    this.shipTypes.set(403, new Ship(403, 0, new Map([[210, 5]]), 100, [6000, 2000], 250))
    this.shipTypes.set(404, new Ship(404, 0, new Map([[210, 5]]), 200, [20000, 15000], 1100))
    this.shipTypes.set(405, new Ship(405, 0, new Map([[210, 5]]), 500, [2000, 6000], 150))
    this.shipTypes.set(407, new Ship(407, 0, new Map([[210, 5]]), 2000, [10000, 10000], 1))
    this.shipTypes.set(408, new Ship(408, 0, new Map([[210, 5]]), 10000, [50000, 50000], 1))
    this.shipTypes.set(409, new Ship(409, 0, new Map([[210, 5]]), 1000000, [10000000, 5000000], 10000))
